...
#define CAP_VDC5_VW         (480u/2u)                    /* use */
...
#define CAP_VDC5_FIELD      (VDC_RES_INTER_INTERLACE)   /* use */

/* Capture resolution */
#define CAP_VDC5_SIZE_VW    (240u)                       /* use */
#define CAP_VDC5_SIZE_HW    (720u)                       /* use */

/* Frame buffer video-signal writing format */
#define CAP_VDC5_WFORMAT    (VDC_RES_MD_YCBCR422)       /* use */
